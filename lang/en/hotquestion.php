...
$string['privacy:metadata:hotquestion_grades'] = 'Question grades';
$string['privacy:metadata:hotquestion_grades:userid'] = 'User who received the grade';
$string['privacy:metadata:hotquestion_grades:rawrating'] = 'Raw rating for the grade.';
