...
$string['crontask'] = 'Background processing for HotQuestion module';
...
$string['evententriesviewed'] = 'Viewed questions';
$string['evententryupdated'] = 'Updated question';
...
$string['historicalroundactualentrydate'] = 'Actual entry date/time: {$a}';
$string['historicalroundclarifystudent'] = 'You are viewing a historical round. Students cannot post in old rounds.';
$string['historicalroundclarifyteacher'] = 'You are viewing a historical round. Teacher/admin can add clarification entries to this selected round using the post box below; entries include the actual entry date/time.';
...
$string['hotquestionmobileapprovalrequired'] = 'Your question has been submitted and is awaiting approval before it appears.';
$string['hotquestionmobileaskquestion'] = 'Ask a Question';
$string['hotquestionmobilelimitedview'] = 'Mobile view currently supports browsing entries. Use the browser view for full posting and moderation actions.';
$string['hotquestionmobilenoask'] = 'Asking questions is not currently available.';
...
$string['maxquestionslessthanminview'] = 'Maximum questions per user must be greater than or equal to the minimum questions required before viewing others.';
$string['maxquestionsperuser'] = 'Maximum questions per user';
$string['maxquestionsperuser_descr'] = 'Set the maximum number of questions each participant can post in the current round. Set to 0 for no limit.';
$string['maxquestionsperuser_help'] = 'If set to a value greater than 0, participants cannot submit more than this number of questions in the current round.';
$string['maxquestionsreached'] = 'You have reached the maximum of {$a->max} question(s) allowed in this round.';
$string['messageprovider:digests'] = 'HotQuestion digests';
$string['messageprovider:notifications'] = 'HotQuestion notifications';
$string['minentriesbeforeviewnotice'] = 'You must post at least {$a->required} question(s) in this round before you can view other participants\' questions. You have posted {$a->current}.';
$string['minquestionsview'] = 'Minimum questions before viewing others';
...
$string['nolatecommenting'] = 'Only teacher/admin can add comments to entries in historical rounds.';
...
$string['resethotquestionquestions'] = 'Delete all questions (and associated votes/comments)';
$string['resethotquestionvotes'] = 'Delete all votes';
$string['returnto'] = 'Return to {$a}';
$string['round'] = 'Round {$a}';
$string['roundid'] = 'Round ID';
$string['search:activity'] = 'HotQuestion - activity information';
...
$string['sortindicatorasc'] = ' (asc)';
$string['sortindicatordesc'] = ' (desc)';
...
$string['vote'] = 'Vote';
$string['whovoted'] = 'Who voted';
$string['whovotedheading'] = 'Who voted';
$string['whovotedvoters'] = 'Voters';
$string['xofn'] = ' of ';
